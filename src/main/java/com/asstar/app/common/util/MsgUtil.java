...
public class MsgUtil {
	...
	public static int send(String phone,String verifyCode,String passCode) throws UnsupportedEncodingException {
		...
		StringEntity entity = new StringEntity("{datas:["+verifyCode+"   ÄúµÄ×¢²áÃÜÂëÊÇ: "+passCode+",30],templateId:1,to:18810455025,appId:8a48b551505b4af001505c33115003e8}", "utf-8");
