...
<body>
	<div data-role="page" style="background-color: white;">
		<div data-role="header" data-position="fixed"
			...
			<form>
				<input type="search" data-mini="true" value=""
		...
		<div role="main" style="background-color: #ddd; margin-top: -123px;">
			<div>
				<div style="width: 100%; height: 60%;" class="WSCSlideWrapper">
					<img class="WSCSlide_img"
						src="resources/img/goods/salesmore/559cf2aeN2ea5ba05.jpg" />
				...
				<div class="ui-block-a">
					<a href="#" style="text-decoration: none;">
						<div class="ui-bar ui-bar-a"
							style="height: 500px; background: white; text-align: center;">
		...
		<div data-role="footer" role="contentinfo" data-position="fixed"
			data-theme="b" class="ui-footer ui-bar-inherit">
			<div data-role="navbar" class="ui-navbar" role="navigation">
				<ul class="ui-grid-b">
					<li class="ui-block-a"><a href="#" data-icon="home"
						class="ui-link ui-btn ui-icon-home ui-btn-icon-top"
						style="font-size: 25px;">首页</a></li>
					<!-- ui-btn-active -->
					<li class="ui-block-b"><a href="#" data-icon="star"
						class="ui-link ui-btn ui-icon-star ui-btn-icon-top"
						style="font-size: 25px;">收藏</a></li>
					<li class="ui-block-c"><a href="#" data-icon="grid"
						class="ui-link ui-btn ui-icon-grid ui-btn-icon-top"
						style="font-size: 25px;">购物车</a></li>
					<li class="ui-block-d"><a href="#" data-icon="user"
						class="ui-link ui-btn ui-icon-user ui-btn-icon-top"
						style="font-size: 25px;">我的</a></li>
				</ul>
			</div>
			<!-- /navbar -->
		</div>
