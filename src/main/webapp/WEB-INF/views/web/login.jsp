		...
		function blurInput(object,msg){
      	...
      	var $parent = $(this).parent();
				if(this.value==""){
					...
					$parent.append('<span class="formtips onError color_orange f12"><br/>'+ errorMsg +'</span>');
					$(this).addClass('blur');
				}else{
					$parent.find('.onError').remove();
...
<div class="i_login p_a">
	<div class="i_login_box">
    	<p><input type="text" placeholder="手机号码/邮箱" class="username" /></p>
    	<p><input type="password" placeholder="密码" class="password"/></p>
    	<p id="lyzp" class="overf"><input name="verifycode" type="text" class="yz fl" style="width: 150px;" placeholder="图片验证码"/>
	        	<a href="javascript:;" class="yzpic fl"><img src="code" height="35" alt="验证码图片" /></a><br/></p>
        ...
        <a href="javascript:;" class="login_btn t_a_c bg_orange">登录</a>
