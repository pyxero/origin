...
<script>
	require(
			[ 'dojo', 'dojo/_base/fx', 'dojo/dom-style',
					'dojo/data/ItemFileReadStore',
					'dijit/tree/ForestStoreModel', 'dijit/Tree',
					'dojox/layout/ContentPane', 'ext/core', 'dojo/parser',
					'dojo/ready' ],
			function(dojo, baseFx, domStyle, ItemFileReadStore,
					ForestStoreModel, Tree, ContentPane, ext, parser, ready) {
				ready(function() {
					parser
							.parse()
							.then(
												...
												.fadeOut(
														{
															...
															onEnd : function() {
																...
																level = function(
																		...
																		array) {
																	for ( var i in array) {
																		if (array[i].menu != null
																				&& array[i].menu.id == obj.id) {
	...
	<div data-dojo-type="dijit/layout/BorderContainer" id="mainContainer"
		...
		<div data-dojo-type="dijit/layout/ContentPane" id="headerPane"
			...
			<table style="width: 100%;">
				<tr>
					...
					<td style="width: 2%;">
						<button data-dojo-id="jsid" data-dojo-type="dijit/form/Button"
							type="button" style="font-size: 12px; font-weight: normal;">
							退出
							<script  type="dojo/on" data-dojo-event="click" data-dojo-args="evt">
								pathname = document.location.pathname;
								location.href = pathname.substr(0, pathname
										.substr(1).indexOf('/') + 1)
										+ '/logout';
							</script>
						</button>
		...
		<div data-dojo-type="dijit/layout/BorderContainer" id="mainSplitter"
			...
			<div data-dojo-type="dijit/layout/AccordionContainer"
				...
				<div data-dojo-type="dijit/layout/ContentPane" id="menu_ContentPane"
			...
			<div data-dojo-type="dijit/layout/TabContainer" id="mainTabContainer"
				...
				<div data-dojo-type="dijit/layout/ContentPane"
					id="welcome_ContentPane" data-dojo-props="title: '首页'"></div>
			</div>
		</div>
	</div>
</body>
