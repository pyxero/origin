...
<script>
	require([ 'dojo', 'dojo/_base/fx', 'dojo/dom-style', 'dojo/data/ItemFileReadStore', 'dijit/tree/ForestStoreModel', 'dijit/Tree',
			'dojox/layout/ContentPane', 'ext/core', 'dojo/parser', 'dojo/ready' ], function(dojo, baseFx, domStyle, ItemFileReadStore, ForestStoreModel, Tree,
			ContentPane, ext, parser, ready) {
		ready(function() {
