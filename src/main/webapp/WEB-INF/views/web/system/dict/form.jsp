...
<div data-dojo-id="G_dict_F" data-dojo-type="dijit/form/Form"
	...
	<table class="dijitDialogPaneContentArea" cellspacing="8">
		...
		<tr>
			...
			<td><input type="text" name="segment"
				data-dojo-type="dijit/form/ValidationTextBox" data-dojo-props="required:true" /></td>
			<td><label>区分名称:</label></td>
			<td><input type="text" name="type" data-dojo-type="dijit/form/ValidationTextBox"
    ...
    $().ready(
		...
		require([ 'dijit/form/Form', 'ext/core' ], function(form, ext) {
			...
			var ds = ext.form.dSelect({
			    name : w
			}, dojo.query('input[name=\'' + w + '\']', dijit
				.byId('G_dict_D').domNode)[0]);
